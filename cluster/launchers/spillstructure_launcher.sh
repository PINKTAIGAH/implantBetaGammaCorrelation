...
outfile_dir="/lustre/gamma/gbrunic/G302/analysis/implantBetaGammaCorrelation/outputs/${infile_basename//anatree.root/spillstructure.root}"
...
.x /lustre/gamma/gbrunic/G302/analysis/implantBetaGammaCorrelation/scripts/spillstructure.C("$infile_dir", "$outfile_dir")
EOF
