...
outfile_dir="/lustre/gamma/gbrunic/G302/analysis/implantBetaGammaCorrelation/outputs/subsystemCoincidence/${infile_basename//anatree.root/subsystemCoincidence.root}"
...
.x /lustre/gamma/gbrunic/G302/analysis/implantBetaGammaCorrelation/scripts/subsystemCoincidence.C("$infile_dir", "$outfile_dir", true)
EOF
