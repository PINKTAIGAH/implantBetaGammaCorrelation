...
outfile_dir="/lustre/gamma/gbrunic/G302/analysis/implantBetaGammaCorrelation/anatrees/${infile_basename//tree.root/wranatree.root}"
...
.x /lustre/gamma/gbrunic/G302/analysis/implantBetaGammaCorrelation/scripts/makeWrAnatrees.C("$infile_dir", "$outfile_dir")
EOF
